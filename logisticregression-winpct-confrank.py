...
# This section replaces any prediction with low certainty (between 0.23 and 0.77) with a guess of 0.64 to either the
...
df_sample_sub.to_csv('2019_Predicitions_logreg_winpct_lowteam.csv', index=False)
# Higher teamID will win
df_sample_sub['Pred'].mask(df_sample_sub['Pred'].between(0.01, 0.99), other=0.36, inplace=True)
df_sample_sub.to_csv('2019_Predicitions_logreg_winpct_highteam.csv', index=False)
